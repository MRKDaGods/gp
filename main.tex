...
\author{
  Abdelrahman Hamdi \quad Ali Ashraf Ali \quad Mohamed Amar Ali \\[4pt]
  Seif Tamer Heakal\,$^{\ast}$ \quad Assoc.\ Prof.\ Ahmed Hamdi \\[6pt]
  \normalsize Department of Computer Engineering, Faculty of Engineering,
    Cairo University, Giza, Egypt \\[4pt]
  \footnotesize\texttt{\{abdelrahman.ibrahim03,\,ali.abdelraouf03,\,mohamed.awaad02,\,seif.mohamed05\}@eng-st.cu.edu.eg} \\[1pt]
  \footnotesize\texttt{ahamdy@eng.cu.edu.eg} \\[4pt]
  \normalsize $^{\ast}$\,Corresponding author: \texttt{seif.mohamed05@eng-st.cu.edu.eg}
}

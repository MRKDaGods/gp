...
>
> Last updated: **2026-07-22** · Current phase: **Phase 5 — Frontend (core COMPLETE; timeline+map view open)** · `production` profile carries transreid+clipsenet+dinov2 fusion → next: Phase 6 domain campaign or Phase 5 timeline/map (gates P1–P4 settled)

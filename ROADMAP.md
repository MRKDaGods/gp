...
- [ ] person-ReID embedder adapter (v1 person weights exist in models/reid + models/person_detection) — person branch currently ships HSV-only in the multiclass profile

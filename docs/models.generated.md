...
|---|---|---|---|---|---:|---|
| vehicle_mtmc_14e_b1 | Vehicle MTMC 14e B1 production | mtmc_vehicle | cityflowv2 | production | no | mtmc_idf1=0.77936 (verified) |
...
| person_mtmc_12b | Person MTMC 12b production | mtmc_person | wildtrack | production | no | idf1_groundplane=0.947 (verified)<br>moda_groundplane=0.903 (verified) |

...
class TestTransReIDModel:
    ...
    def test_forward_inference_clip(self):
        ...
        from athar.components.embedders.transreid_model import TransReID
...
class TestReIDModelTransReIDRouting:
    ...
    def test_clip_normalization_auto_detect(self):
        ...
        from athar.components.embedders.reid_model import _CLIP_MEAN, _CLIP_STD, _IMAGENET_MEAN, _IMAGENET_STD
    ...
    def test_eva02_vit_model_fallback(self, monkeypatch):
        ...
        from athar.components.embedders import transreid_model
        from athar.components.embedders.reid_model import ReIDModel
...
class TestResNet50IBNModel:
    ...
    def test_resnet50_ibn_global_eval_feature_shape(self):
        ...
        from athar.training.model import ReIDModelResNet50IBN
